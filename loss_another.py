...
def main():
    criterion_softmax = GE2ELoss(init_w=10.0, init_b=-5.0, loss_method='softmax') #for softmax loss
    criterion_contrast = GE2ELoss(init_w=10.0, init_b=-5.0, loss_method='contrast') #for contrast loss
    ...
    loss = criterion_softmax(test_input) #output is a scalar
    print(loss)

    loss = criterion_contrast(test_input)
    print(loss)
